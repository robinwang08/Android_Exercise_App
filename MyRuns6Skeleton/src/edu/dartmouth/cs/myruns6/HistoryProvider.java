...
//The HistoryProvider class is the ContentProvider of the MyRuns app.
//It stores all the ExerciseEntry into the ContentProvider. 


// Your HistoryProvider needs to implement update(), insert(),delete() and query() methods. 
// These methods map more or less directly to the SQLiteDatabase interface. 
...
public class HistoryProvider extends ContentProvider {
	  ...
	  private static final String AUTHORITY = "edu.dartmouth.cs.myruns.historyprovider";
